...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ScoreByLabelArgs)(nil), (*config.ScoreByLabelArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_ScoreByLabelArgs_To_config_ScoreByLabelArgs(a.(*ScoreByLabelArgs), b.(*config.ScoreByLabelArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ScoreByLabelArgs)(nil), (*ScoreByLabelArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ScoreByLabelArgs_To_v1beta2_ScoreByLabelArgs(a.(*config.ScoreByLabelArgs), b.(*ScoreByLabelArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_ScoreByLabelArgs_To_config_ScoreByLabelArgs(in *ScoreByLabelArgs, out *config.ScoreByLabelArgs, s conversion.Scope) error {
	if err := v1.Convert_Pointer_string_To_string(&in.LabelKey, &out.LabelKey, s); err != nil {
		return err
	}
	return nil
}

//Convert_v1beta2_ScoreByLabelArgs_To_config_ScoreByLabelArgs is an autogenerated conversion function.
func Convert_v1beta2_ScoreByLabelArgs_To_config_ScoreByLabelArgs(in *ScoreByLabelArgs, out *config.ScoreByLabelArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_ScoreByLabelArgs_To_config_ScoreByLabelArgs(in, out, s)
}

func autoConvert_config_ScoreByLabelArgs_To_v1beta2_ScoreByLabelArgs(in *config.ScoreByLabelArgs, out *ScoreByLabelArgs, s conversion.Scope) error {
	if err := v1.Convert_string_To_Pointer_string(&in.LabelKey, &out.LabelKey, s); err != nil {
		return err
	}
	return nil
}

//Convert_config_ScoreByLabelArgs_To_v1beta2_ScoreByLabelArgs is an autogenerated conversion function.
func Convert_config_ScoreByLabelArgs_To_v1beta2_ScoreByLabelArgs(in *config.ScoreByLabelArgs, out *ScoreByLabelArgs, s conversion.Scope) error {
	return autoConvert_config_ScoreByLabelArgs_To_v1beta2_ScoreByLabelArgs(in, out, s)
}
