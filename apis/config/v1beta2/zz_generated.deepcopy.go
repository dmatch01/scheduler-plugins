...
//DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScoreByLabelArgs) DeepCopyInto(out *ScoreByLabelArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.LabelKey != nil {
...
//DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a newScoreByLabelArgs.
func (in *ScoreByLabelArgs) DeepCopy() *ScoreByLabelArgs {
	if in == nil {
		return nil
	}
	out := new(ScoreByLabelArgs)
	in.DeepCopyInto(out)
	return out
}

//DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a newruntime.Object.
func (in *ScoreByLabelArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
